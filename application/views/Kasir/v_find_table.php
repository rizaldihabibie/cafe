                                ...
                                <div class="col-md-6">
                                  ...
                                  <td> 
                                    <div class="toggle-btn-grp cssonly shaon" id="no_meja"> 
	                                  <div><input type="checkbox" name="<?php echo $row1->id_meja ?>" value=<?php echo $row1->no_meja ?> disabled/>
                                  ...
                                  <div class="toggle-btn-grp cssonly" id="no_meja">  
	                                 <div><input type="checkbox" name="<?php echo $row1->id_meja ?>" value=<?php echo $row1->no_meja ?> />
	                                  <label onclick=\"\" class="toggle-btn" > <?php echo $row1->no_meja; ?></label>
	                                </div>
                                 </div>
                                 ...
                                 ?>
                                  ...
                                  <td> 
                                    <div class="toggle-btn-grp cssonly shaon" id="no_meja"> 
	                                  <div><input type="checkbox" name="<?php echo $row2->id_meja ?>" value="<?php echo $row2->no_meja ?>" disabled/>
                                   ...
                                   <td>
                                  <div class="toggle-btn-grp cssonly" id="no_meja">  
	                                 <div><input type="checkbox" name="<?php echo $row2->id_meja ?>" value=<?php echo $row2->no_meja ?> />
	                                  <label onclick=\"\" class="toggle-btn" > <?php echo $row2->no_meja; ?></label>
	                                </div>
                                 </div>
                                 </td>
